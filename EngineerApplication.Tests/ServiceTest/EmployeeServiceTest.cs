...
namespace EngineerApplication.Tests.ServiceTest
{
  public class EmployeeServiceTest
  {
    ...
    public void TestGetByIdEmployee(int id)
    {
      ...
      var resultService = _employeeService.Setup(p => p.Get(id)).Returns(employee);
    ...
    public void TestPostEmployeeMethodForPage(int id)
    {
      ...
      var addedEmployee = _employeeService.Setup(x => x.Get(id)).Returns(employee1);
    ...
    public void TestPutEmployeeMethodForPage(int id)
    {
      ...
      _employeeService.Setup(x => x.Update(employee1)).Verifiable();
      var editedEmployee = _employeeService.Setup(x => x.Get(id)).Returns(employee1);
